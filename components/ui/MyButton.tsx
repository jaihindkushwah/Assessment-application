...
const buttonVariants = cva(
  "active:scale-95 text-center active:duration-75 transition-all ease-in-out dark:bg-inherit ",
  {
    variants: {
      variant: {
        default:
          "dark:bg-black rounded-full flex items-center bg-white bg-slate-900 text-black dark:text-white  text-center dark:hover:bg-blue-800/50 hover:bg-slate-300/40 dark:border-white border-black",
